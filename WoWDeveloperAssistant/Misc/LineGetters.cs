        ...
        public static BuildVersions GetBuildVersion(IEnumerable<string> lines)
        {
            foreach (var line in lines)
            {
                if (line.Contains("Detected build:"))
                {
                    ...
                    else if (line.Contains("11_1_7"))
                        return BuildVersions.BUILD_11_1_7;
                    else if (line.Contains("11_2_0"))
                        return BuildVersions.BUILD_11_2_0;
                    else if (line.Contains("11_2_5"))
                        return BuildVersions.BUILD_11_2_5;
                    else if (line.Contains("11_2_7"))
